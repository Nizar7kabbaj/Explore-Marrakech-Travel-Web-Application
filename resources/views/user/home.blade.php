...
@section('content')
      ...
      {{-- Home Image --}}
        <img src="{{ asset('image/wallpaperflare.com_wallpaper (4).jpg') }}" height="750"  class="d-block w-100" style="margin-top: -120px"; alt="main image">
        {{-- Image Text --}}
        <div class="mainTextPosition text-center">
  <h5 class="mainTextSize" style="font-size: 70px; font-family: 'Impact', sans-serif; font-weight: bold;">Explore Marrakech at Your Own Pace</h5>
  <p style="font-size: 32px; font-family: 'Courier New', monospace; font-weight: bold;">Where Every Road Becomes Your Story</p>
</div>

        
        <pre class="text-center fs-3 mt-3">Wellcome To Marrakech🙏</pre>
        ...
        <div class="container mt-5">
            {{-- <div class="d-flex justify-content-between">
                <div>
                    ...
                    <pre>Explore Marrakech's Gems in a Day</pre>
                </div>
                <div>
                        ...
                        <a href="your_destination_page_url" class="no-decoration">
                            <div class="card d-inline-flex p-1" style="width: 18rem;">
                                <img src="{{ asset('image/cart_image1.png') }}" class="card-img-top object-fit-fill" alt="...">
                                    <div class="card-body">
                                        <p>time . category</p>
                                        <h5 class="card-title">Day Tour to jamafna</h5>
                                        <p class="card-text">Explore the Rich Heritage of jamafna with a Visit to Pinnawala Elephant Orphanage</p>
                                    </div>
                        ...
                        <a href="your_destination_page_url" class="no-decoration">
                            <div class="card d-inline-flex p-1" style="width: 18rem;">
                                <img src="{{ asset('image/cart_image1.png') }}" class="card-img-top object-fit-fill" alt="...">
                                    <div class="card-body">
                                        <p>time . category</p>
                                        <h5 class="card-title">Day Tour to Marrakech</h5>
                                        <p class="card-text">Explore the Rich Heritage of Marrakech with a Visit to Pinnawala Elephant Orphanage</p>
                                    </div>
        ...
        <div class="container-fluid mt-5 section-bg-color-home">
            <div class="row ">
                <div class="col m-5">
                    {{-- <pre>Elevate Your Marrakech Adventure</pre> --}}
                    <h2>Discover the Marrakech Tours Difference</h2>
                    <p>At Marrakech Tours Travels, we go beyond being just a travel agency; 
        ...
        {{-- youtube video --}}
        <div class="m-5">
    <iframe width="1150" height="550" src="https://www.youtube.com/embed/aUSnYBw2LAs?si=tPDnaH9cre-PBT2w" 
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <div class="col-7 review-bg p-4 text-justify">
                            ...
                            <hr/>
                            <p class="font-monospace">Amal <br/> Marrakech</p>
                        </div>
                      </div>
                    </div>
